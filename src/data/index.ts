...
export const initialMap: typeof InitialMapType = loadJSON5(
  "initialMap.json5"
);
export const Pinin2Hanz: typeof Pinin2HanzType = loadJSON5(
  "Pinin2Hanz.json5"
);
export const voidInitialMap: typeof VoidInitialMapType = loadJSON5(
  "voidInitialMap.json5"
);
